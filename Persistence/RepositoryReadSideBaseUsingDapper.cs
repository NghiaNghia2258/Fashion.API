...
{
    public abstract class RepositoryReadSideBaseUsingDapper<T, TKey> : IRepositoryReadSideBaseUsingDapper<T, TKey> where T : EntityBase<TKey>
    {
        ...
        {
            // Kiểm tra xem propertyName có phải là thuộc tính liên kết hay không
