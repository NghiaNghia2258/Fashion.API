...
namespace Persistence.Migrations
{
    ...
    [Migration("20240910104329_UpdateVoucher")]
            ...
            modelBuilder.Entity("Fashion.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d5e3ee84-5efa-47cd-b009-faa849a5a74d"),
                            Name = "Create_Product"
                        },
                        new
                        {
                            Id = new Guid("21135a77-935a-46d9-8ce7-9571d2233f5c"),
                            Name = "Find_Product"
                        });
                });
            ...
            modelBuilder.Entity("Fashion.Domain.Entities.RoleGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b479e87e-ac98-4812-ac42-3c807dc84eed"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("7f03b2da-e40e-42cf-946d-defe75ddc577"),
                            Name = "User"
                        });
                });
